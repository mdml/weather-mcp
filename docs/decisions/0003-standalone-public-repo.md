...
- **Hosting: Fly.io** (deferred to Phase 3 — see [0006](0006-phased-delivery.md)).
...
- A self-contained, reproducible deploy story for an open-source project. Phase 3's remote +
